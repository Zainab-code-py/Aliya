...
# Load the data
net_sales = pd.read_csv('C:/Users/Aliya/Downloads/quarterly_net_quantity.csv', dtype={'Country Code': str, 'Brand': str}, low_memory=False)
net_transactions = pd.read_csv('C:/Users/Aliya/Downloads/quarterly_net_transactions.csv', dtype={'Country Code': str, 'Brand': str}, low_memory=False)
...
merged_data['TY_Net_UPT'] = merged_data.apply(lambda row: safe_divide(row['TY_Net_Sales'], row['TY_Orders']), axis=1)
merged_data['LY_Net_UPT'] = merged_data.apply(lambda row: safe_divide(row['LY_Net_Sales'], row['LY_Orders']), axis=1)
...
result.to_csv('C:/Users/Aliya/Downloads/quarterly_net_upt.csv', index=False)
result.to_excel('C:/Users/Aliya/Downloads/quarterly_net_asp.xlsx', index=False)

print("Net UPT data has been successfully saved.")
