...
result.to_csv('C:/Users/Aliya/Downloads/quarterly_net_aov.csv', index=False)
result.to_excel('C:/Users/Aliya/Downloads/quarterly_net_aov.xlsx', index=False)

print("Net AOV data has been successfully saved.")
